...
def get_data_loss(csvfile, writer, model, data_loader):
    global args, Each_Attr_id
    print("Start testing")
    if args.Branch==1:
        pass
    elif args.Branch==17:
        mix_multi_task_test_loss_epoch(csvfile, writer, model, Each_Attr_id, data_loader)
...
def main():
    ...
    writer.writeheader()
    data_loader = dataset.train_loader(args.data_path, args.relative_path, batch_size=16, num_workers=10, pin_memory=True)
